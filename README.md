...
## Build & run (example)
If your program file is `main.cpp`, compile and run with:

```bash
g++ -std=c++17 -o assignment2 main.cpp
./assignment2
```

Have fun implementing it — and let me know if you want a full sample C++ implementation.
